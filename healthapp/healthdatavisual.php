...
if (isset($_GET['action'])) {
    ...
    if ($_GET['action'] === 'get_data') {
        ...
        try {
            ...
            $dateColumn = null;
            $dateColumns = ['created_at', 'date', 'timestamp', 'service_date', 'recorded_at'];
            ...
            if (!empty($year) && $dateColumn) {
                $whereClauses[] = "YEAR(`$dateColumn`) = ?";
                $params[] = $year;
            }
            
            if (!empty($month) && $dateColumn) {
                $whereClauses[] = "MONTH(`$dateColumn`) = ?";
                $params[] = $month;
            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load initial columns for the first table
